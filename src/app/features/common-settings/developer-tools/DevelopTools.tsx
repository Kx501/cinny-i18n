        ...
        <Box grow="Yes" gap="200">
          <Box grow="Yes" alignItems="Center" gap="200">
            <Text size="H3" truncate>
              {t('features:common-settings.developer-tools.developer_tools')}
            </Text>
          </Box>
          <Box shrink="No">
          ...
          <PageContent>
            <Box direction="Column" gap="700">
              <Box direction="Column" gap="100">
                <Text size="L400">{t('features:common-settings.developer-tools.options')}</Text>
                <SequenceCard
                ...
                >
                  <SettingTile
                    title={t('features:common-settings.developer-tools.enable_developer_tools')}
                    after={
                      <Switch
                        variant="Primary"
                ...
                {developerTools && (
                  ...
                  >
                    <SettingTile
                      title={t('features:common-settings.developer-tools.room_id')}
                      description={`${t('features:common-settings.developer-tools.copy_room_id_to_clipboard')} ("${room.roomId}")`}
                      after={
                        <Button
                          ...
                          outlined
                        >
                          <Text size="B300">{t('features:common-settings.developer-tools.copy')}</Text>
                        </Button>
                      }
                    />
                  </SequenceCard>
              ...
              {developerTools && (
                <Box direction="Column" gap="100">
                  <Text size="L400">{t('features:common-settings.developer-tools.data')}</Text>
                  ...
                  >
                    <SettingTile
                      title={t('features:common-settings.developer-tools.new_message_event')}
                      description={t('features:common-settings.developer-tools.create_and_send_new_message')}
                      after={
                        <Button
                          ...
                          outlined
                        >
                          <Text size="B300">{t('features:common-settings.developer-tools.compose')}</Text>
                        </Button>
                      }
                    />
                  </SequenceCard>
                  ...
                  >
                    <SettingTile
                      title={t('features:common-settings.developer-tools.room_state')}
                      description={t('features:common-settings.developer-tools.state_events_of_the_room')}
                      after={
                        <Button
                        ...
                        >
                          <Text size="B300">{expandState ? t('features:common-settings.developer-tools.collapse') : t('features:common-settings.developer-tools.expand')}</Text>
                        </Button>
                      }
                    />
                    {expandState && (
                      <Box direction="Column" gap="100">
                        <Box justifyContent="SpaceBetween">
                          <Text size="L400">{t('features:common-settings.developer-tools.events')}</Text>
                          <Text size="L400">{t('features:common-settings.developer-tools.total')}{roomState.size}</Text>
                        </Box>
                        <CutoutCard>
                          <MenuItem
                          ...
                          >
                            <Box grow="Yes">
                              <Text size="T200" truncate>
                                {t('features:common-settings.developer-tools.add_new')}
                              </Text>
                            </Box>
                          </MenuItem>
                                      ...
                                      {Array.from(stateKeyToEvents.keys())
                                        ...
                                        .map((stateKey) => (
                                          ...
                                          >
                                            <Box grow="Yes">
                                              <Text size="T200" truncate>
                                                {stateKey ? `"${stateKey}"` : t('features:common-settings.developer-tools.default')}
                                              </Text>
                                            </Box>
                                          </MenuItem>
                                        ))}
                  ...
                  >
                    <SettingTile
                      title={t('features:common-settings.developer-tools.account_data')}
                      description={t('features:common-settings.developer-tools.private_personalization_data')}
                      after={
                        <Button
                        ...
                        >
                          <Text size="B300">{expandAccountData ? t('features:common-settings.developer-tools.collapse') : t('features:common-settings.developer-tools.expand')}</Text>
                        </Button>
                      }
                    />
                    {expandAccountData && (
                      <Box direction="Column" gap="100">
                        <Box justifyContent="SpaceBetween">
                          <Text size="L400">{t('features:common-settings.developer-tools.events')}</Text>
                          <Text size="L400">{t('features:common-settings.developer-tools.total')}{accountData.size}</Text>
                        </Box>
                        <CutoutCard>
                          <MenuItem
                            variant="Surface"
