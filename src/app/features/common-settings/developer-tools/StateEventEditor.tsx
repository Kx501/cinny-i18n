  ...
  return (
    ...
    >
      <Box shrink="No" direction="Column" gap="100">
        <Text size="L400">{t('features:common-settings.developer-tools.state_event')}</Text>
        <SequenceCard
          ...
          <SettingTile
            ...
            after={
              <Box gap="200">
                ...
                >
                  <Text size="B300">{t('features:common-settings.developer-tools.save')}</Text>
                </Button>
                <Button
                  variant="Secondary"
                  fill="Soft"
                  ...
                  disabled={submitting}
                >
                  <Text size="B300">{t('features:common-settings.developer-tools.cancel')}</Text>
                </Button>
              </Box>
            }
          />
        ...
        <Box gap="200" alignItems="End">
          ...
          {onEditContent && (
            <Box shrink="No" gap="200">
              ...
              >
                <Text size="B300">{t('features:common-settings.developer-tools.edit')}</Text>
              </Chip>
            </Box>
          )}
        </Box>
