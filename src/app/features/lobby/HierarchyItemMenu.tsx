  ...
  return (
    ...
    >
      <Text as="span" size="T300" truncate>
        {content.suggested ? t('features:lobby.unset_suggested') : t('features:lobby.set_suggested')}
      </Text>
    </MenuItem>
  );
}
                ...
                {joined && (
                  <Box direction="Column" gap="100" style={{ padding: config.space.S100 }}>
                    {onTogglePin && (
                      ...
                      >
                        <Text as="span" size="T300" truncate>
                          {pinned ? t('features:lobby.unpin_from_sidebar') : t('features:lobby.pin_to_sidebar')}
                        </Text>
                      </MenuItem>
                    )}
                    <InviteMenuItem
