        ...
        <Box alignItems="Center" gap="Inherit" grow="Yes" direction={compact ? 'Column' : 'Row'}>
                    ...
                    <Box direction="Column" style={{ padding: config.space.S100 }}>
                      ...
                      >
                        <Text size="B300" truncate>
                          {spotlight ? t('features:call.grid_view') : t('features:call.spotlight_view')}
                        </Text>
                      </MenuItem>
                      <MenuItem
                        size="300"
          ...
          <Box shrink="No" direction="Column">
            <Button
              ...
              disabled={exiting}
            >
              <Text size="B400">{t('features:call-status.end')}</Text>
            </Button>
          </Box>
        </Box>
      </SequenceCard>
