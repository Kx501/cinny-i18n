        ...
        <Box grow="Yes" gap="200">
          <Box grow="Yes" alignItems="Center" gap="200">
            <Text size="H3" truncate>
              {t('features:settings.devices.devices')}
            </Text>
          </Box>
          <Box shrink="No">
        ...
        <Scroll hideTrack visibility="Hover">
          <PageContent>
            <Box direction="Column" gap="700">
              <Box direction="Column" gap="100">
                <Text size="L400">{t('features:settings.devices.security')}</Text>
                <SequenceCard
                ...
                >
                  <SettingTile
                    title={t('features:settings.devices.device_verification')}
                    description={t('features:settings.devices.to_verify_device_identity')}
                    after={
                      <>
              ...
              <Box direction="Column" gap="100">
                <Text size="L400">{t('features:settings.devices.current')}</Text>
                {currentDevice ? (
                  <SequenceCard
                    className={SequenceCardStyle}
                    variant="SurfaceVariant"
