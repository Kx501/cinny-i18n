  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('settings.notifications.keywordMessages.title')}</Text>
        <Box gap="100">
          <Text size="T200">{t('settings.notifications.keywordMessages.badge')}: </Text>
      ...
      >
        <SettingTile
          title={t('settings.notifications.keywordMessages.selectKeyword')}
          description={t('settings.notifications.keywordMessages.selectKeywordDescription')}
        >
          <KeywordInput />
        </SettingTile>
      </SequenceCard>
      {keywordPushRules.map((pushRule) => (
        ...
        >
          <SettingTile
            title={t('settings.notifications.keywordMessages.keywordPattern', { pattern: pushRule.pattern })}
