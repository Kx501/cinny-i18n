  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('settings.notifications.specialMessages.title')}</Text>
        <Box gap="100">
          <Text size="T200">{t('settings.notifications.specialMessages.badge')}: </Text>
      ...
      >
        <SettingTile
          title={t('settings.notifications.specialMessages.mentionUserId', { userId })}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={displayName 
            ? t('settings.notifications.specialMessages.containsDisplayNameWithName', { displayName })
            : t('settings.notifications.specialMessages.containsDisplayName', { displayName: '' })
          }
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={t('settings.notifications.specialMessages.containsUsername', { username: getMxIdLocalPart(userId) })}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={t('settings.notifications.specialMessages.mentionRoom')}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={t('settings.notifications.specialMessages.containsRoom')}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
