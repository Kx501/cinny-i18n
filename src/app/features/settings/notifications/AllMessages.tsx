  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('settings.notifications.allMessages.title')}</Text>
        <Box gap="100">
          <Text size="T200">{t('settings.notifications.allMessages.badge')}: </Text>
      ...
      >
        <SettingTile
          title={t('settings.notifications.allMessages.oneToOneChats')}
      ...
      >
        <SettingTile
          title={t('settings.notifications.allMessages.oneToOneChatsEncrypted')}
          after={
      ...
      >
        <SettingTile
          title={t('settings.notifications.allMessages.roomsEncrypted')}
          after={
            <AllMessagesModeSwitcher
              pushRules={pushRules}
