...
export function ContactInformation() {
  ...
  return (
    <Box direction="Column" gap="100">
      <Text size="L400">{t('features:settings.account.contact_information')}</Text>
      <SequenceCard
        ...
        gap="400"
      >
        <SettingTile title={t('features:settings.account.email_address')} description={t('features:settings.account.email_address_attached')}>
          <Box>
            {emailIds?.map((email) => (
