  ...
  return (
    <Box as="form" onSubmit={handleSubmit} gap="200" aria-disabled={ignoring}>
      ...
      >
        ...
        <Text size="B400">{t('settings.account.blockedUsers.block')}</Text>
      </Button>
    </Box>
  );
}
  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('settings.account.blockedUsers.title')}</Text>
      </Box>
      <SequenceCard
      ...
      >
        <SettingTile
          title={t('settings.account.blockedUsers.selectUser.title')}
          description={t('settings.account.blockedUsers.selectUser.description')}
        >
