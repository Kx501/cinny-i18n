  ...
  return (
    <Box as="form" onSubmit={handleSubmit} gap="200" aria-disabled={ignoring}>
      ...
      >
        ...
        <Text size="B400">{t('features:settings.account.block')}</Text>
      </Button>
    </Box>
  );
}
  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('features:settings.account.blocked_users')}</Text>
      </Box>
      <SequenceCard
      ...
      >
        <SettingTile
          title={t('features:settings.account.select_user')}
          description={t('features:settings.account.prevent_receiving')}
        >
          <Box direction="Column" gap="300">
            <IgnoreUserInput userList={ignoredUsers} />
            {ignoredUsers.length > 0 && (
              <Box direction="Inherit" gap="100">
                <Text size="L400">{t('features:settings.account.users')}</Text>
