    ...
    return (
      <Box grow="Yes" direction="Column" gap="700" {...props} ref={ref}>
            ...
            <Box alignItems="Center" gap="400">
              <Box grow="Yes" direction="Column">
                {applyState.status === AsyncStatus.Error ? (
                  <Text size="T200">
                    <b>{t('components:image-pack-view.failed_to_apply_changes')}</b>
                  </Text>
                ) : (
                  <Text size="T200">
                    <b>{t('components:image-pack-view.changes_saved')}</b>
                  </Text>
                )}
              </Box>
              <Box shrink="No" gap="200">
                ...
                >
                  <Text size="B300">{t('components:image-pack-view.apply_changes')}</Text>
                </Button>
              </Box>
            </Box>
          </Menu>
        ...
        <Box direction="Column" gap="100">
          <Text size="L400">{t('components:image-pack-view.pack')}</Text>
          <SequenceCard
            style={{ padding: config.space.S300 }}
          ...
          >
            <SettingTile
              title={t('components:image-pack-view.images_usage')}
              description={t('components:image-pack-view.select_how_images_used')}
              after={
                <UsageSwitcher
        ...
        {images.length === 0 && !canEdit ? null : (
          <Box direction="Column" gap="100">
          <Text size="L400">{t('components:image-pack-view.images')}</Text>
            {canEdit && (
              <SequenceCard
                style={{ padding: config.space.S300 }}
                variant="SurfaceVariant"
              ...
              >
                <SettingTile
                  title={t('components:image-pack-view.upload_images')}
                  description={t('components:image-pack-view.select_images_from_storage')}
                  after={
                    <Button
                      variant="Secondary"
                      fill="Soft"
                    ...
                    >
                      <Text size="B300">{t('components:image-pack-view.select')}</Text>
                    </Button>
                  }
                />
              </SequenceCard>
