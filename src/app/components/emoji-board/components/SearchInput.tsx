...
export function SearchInput({
  ...
  return (
    <Input
      ...
      size="400"
      placeholder={allowTextCustomEmoji ? t('components:emoji-board.components.search_or_text_reaction') : t('components:emoji-board.components.search')}
      maxLength={50}
      after={
        allowTextCustomEmoji && query ? (
          <Chip
            ...
            onClick={handleReact}
          >
            <Text size="L400">{t('components:emoji-board.components.react')}</Text>
          </Chip>
        ) : (
